...
function machines.get_furnace_active_formspec(pos, percent)
	local formspec =
		"size[8,9]"..
...
machines.furnace_inactive_formspec =
	"size[8,9]"..
...
minetest.register_abm({
	...
	action = function(pos, node, active_object_count, active_object_count_wider)
		...
		if meta:get_float("fuel_time") < meta:get_float("fuel_totaltime") then
			...
			meta:set_string("formspec",machines.get_furnace_active_formspec(pos, percent))
			return
		end
